...
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");var _app = _interopRequireDefault(require("./layout/app"));
var _sidenav = _interopRequireDefault(require("./layout/sidenav"));
...
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var App = /*#__PURE__*/function () {
  function App() {(0, _classCallCheck2["default"])(this, App);
    this.init();
  }(0, _createClass2["default"])(App, [{ key: "init", value: function init()

    {var _this = this;
      $("section .code-block").map(function (key, el) {
        $(el).after("<pre><code class=\"language-html\">".concat(
        _this.safetext(
        el.innerHTML), "</code></pre>"));


      });
    } }, { key: "safetext", value: function safetext(
    text) {
      var table = {
        "<": "lt",
        ">": "gt",
...
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var Sidenav = /*#__PURE__*/function () {
  function Sidenav() {(0, _classCallCheck2["default"])(this, Sidenav);
    ...
    this.closeBtn = this.layoutSidenav.find(".close-btn");
    this.sidenavBtn = $("#sidenav-btn");

    this.init();
  }(0, _createClass2["default"])(Sidenav, [{ key: "init", value: function init()
    {
      this.open_sidenav();
      this.close_sidenav();
      this.highlight_current_slug();
      this.nav_position();
    } }, { key: "open_sidenav", value: function open_sidenav()

    {var _this = this;
      this.sidenavBtn.on("click", function (ev) {
        _this.layoutSidenav.css({
          transform: "translateX(0)" });

        $(ev.currentTarget).fadeOut(160);
      });
    } }, { key: "close_sidenav", value: function close_sidenav()

    {var _this2 = this;
      this.closeBtn.on("click", function (ev) {
        _this2.layoutSidenav.css({
          transform: "" });

        _this2.sidenavBtn.fadeIn(160);
      });
    } }, { key: "highlight_current_slug", value: function highlight_current_slug()

    {
      var url = window.location.href;
      var linkArr = [];
      this.layoutSidenav.find(".item a").map(function (i, el) {
        if (url.includes(el.href)) {
          linkArr.push(el);
        }
      });
      $(linkArr[linkArr.length - 1]).addClass("active");
    }
    /**
     * 侧边栏定位
     */ }, { key: "nav_position", value: function nav_position()
    {
      // let offset = $(".s-summary-list .item>.active").offset().top;

      // $(".layout-sidenav,#js-menu").animate(
      //   {
      ...
      if ($(".s-summary-list .item:not(.home) .active").length < 1) {
        window.localStorage.removeItem("offsetTop");
      }
      var storageNum = window.localStorage.getItem("offsetTop");
      var $item = $(".s-summary-list .item>a");
      var offset = 0;
      var scroll_Fn = function scroll_Fn(el, scrollNum) {
        $(el).animate(
        {
          scrollTop: scrollNum },
      ...
      if (storageNum) {
        ...
        scroll_Fn(".layout-sidenav", storageNum) :
        scroll_Fn("#js-menu", storageNum);
      }

      $item.on("click", function (ev) {
        offset =
        window.innerWidth > 1500 ?
        $(".layout-sidenav").get(0).scrollTop :
        $("#js-menu").get(0).scrollTop;

        window.localStorage.setItem("offsetTop", offset);
      });
...
},{"@babel/runtime/helpers/classCallCheck":28,"@babel/runtime/helpers/createClass":29,"@babel/runtime/helpers/interopRequireDefault":30}],5:[function(require,module,exports){
...
},{"@babel/runtime/helpers/classCallCheck":28,"@babel/runtime/helpers/createClass":29,"@babel/runtime/helpers/interopRequireDefault":30}],10:[function(require,module,exports){
