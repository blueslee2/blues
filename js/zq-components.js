...
Lists = /*#__PURE__*/function () {
  function Lists() {(0, _classCallCheck2["default"])(this, Lists);
    this.init();
  }(0, _createClass2["default"])(Lists, [{ key: "init", value: function init()
    {
      this.default_list_rows();
      this.has_attrs_list_rows();
...
Article = /*#__PURE__*/function () {
  function Article() {(0, _classCallCheck2["default"])(this, Article);
    ...
    {var _this = this;
      this.setFlexibleDescription();
      $(".article-box.layout-6").map(function (index, el) {return (
          _this.setLayout6AutoHeightTitle($(el)));});

    } }, { key: "setLayout6AutoHeightTitle", value: function setLayout6AutoHeightTitle(

    el) {var _this2 = this;
      this.calcLayout6TitleHeight(el);
      //  绑定resize监听
      var resize = function resize() {
        _this2.calcLayout6TitleHeight(el);
      };

      $(window).on("resize", this.debounce(resize, 200));
    } }, { key: "calcLayout6TitleHeight", value: function calcLayout6TitleHeight(

    el) {
      var titles = el.find(".article-card-section-title");
      //  计算出最高的
      var maxHeight = 0;
      titles.map(function (index, title) {
        if ($(title).outerHeight() > maxHeight) {
          maxHeight = $(title).outerHeight();
        }
      });
      //  给所有title设置高度一致
      titles.map(function (index, title) {
        $(title).css("min-height", "".concat(maxHeight, "px"));
      });
    } }, { key: "debounce", value: function debounce(

    fn, delay) {var _arguments = arguments;
      delay = delay || 100;
      return function () {
    ...
    } }, { key: "setFlexibleDescription", value: function setFlexibleDescription()

    {
      /*layout-3*/
      new _flexibleDescription["default"]({
        selector: ".article-box.layout-3 .article-card-meta",
        rows: 99,
        titleSelector: ".article-card-title",
        descriptionSelector: ".article-card-description",
        responsive: [
        {
          breakpoint: 300,
          rows: 3 },
      ...
      /*layout-8*/
      new _flexibleDescription["default"]({
        selector: ".article-box.layout-8 .article-card-meta",
        rows: 99,
        titleSelector: ".article-card-title",
        descriptionSelector: ".article-card-description",
        responsive: [
...
},{"../vendor/flexible-description.min":19,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],3:[function(require,module,exports){
...
AudioPlayer = /*#__PURE__*/function () {
  function AudioPlayer() {(0, _classCallCheck2["default"])(this, AudioPlayer);
    ...
    //  初始化vAudio播放器
      ...
      var _this = this;
      var audioUrl = $(".audio-player").data("url");
...
},{"../vendor/range.min":20,"../vendor/v-audio.min":23,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],4:[function(require,module,exports){
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var Banner = /*#__PURE__*/function () {
  function Banner() {(0, _classCallCheck2["default"])(this, Banner);
    this.init();
  }(0, _createClass2["default"])(Banner, [{ key: "init", value: function init()

    {
      this.banner1_banner2_slick();
      this.banner3_slick();
      this.banner5_slick();
    } }, { key: "banner1_banner2_slick", value: function banner1_banner2_slick()

    {
      var $bannerCardSlick = $(".banner-carousel-1, .banner-carousel-2");
      var options = {
        infinite: true,
        slidesToShow: 1,
        slidesToScroll: 1,
      ...
      $bannerCardSlick.slick(options);
      $bannerCardSlick.on("beforeChange", function () {
        window.LazyLoad.update();
      });
    } }, { key: "banner3_slick", value: function banner3_slick()

    {
      var $bannerCardSlick = $(".banner-carousel-3");
      var $largetItem = $(".large-ban .ban-item").clone().addClass("md-hide");
      ...
      $bannerCardSlick.prepend($largetItem).slick(options);
      $bannerCardSlick.on("beforeChange", function () {
        window.LazyLoad.update();
      });

      this.slick_revival($bannerCardSlick, options);
    } }, { key: "banner5_slick", value: function banner5_slick()
    ...
    {var _this = this;
      ...
      function () {
        var swiper = new Swiper(".swiper-container", {
          ...
          navigation: {
            nextEl: ".swiper-container .slick-next",
            prevEl: ".swiper-container .slick-prev" },
        ...
        setTimeout(function () {
          $bannerCardSlick.removeClass("init");
          //  初始化图片显示
          var $img = $(".swiper-slide-prev,.swiper-slide-next").find(
          "img.lazy:not(.loaded)");
        ...
        _this.user_interaction(swiper);
      });

    } }, { key: "user_interaction", value: function user_interaction(
    ...
    swiper) {
      ...
      //  点击左右按钮开启自动轮播
      $(".swiper-container .slick-arrow").on("click", function () {
        swiper.autoplay.start();
      });
    } }, { key: "slick_revival", value: function slick_revival(

    $mySlick, options) {
      $mySlick.on("destroy", function (ev, slick) {
        ev.currentTarget.dataset.slickInit = false;
      });

      $mySlick.map(function (k, item) {
        item.dataset.slickInit = false;
      });

      $(window).on("resize orientationchange", function () {
        if (window.innerWidth < 767) {
          $mySlick.map(function (k, el) {
            if (
            !~el.className.indexOf("slick-initialized") &&
            el.dataset.slickInit == "false")
            {
              $(el).slick(options);
              el.dataset.slickInit = true;
            }
          });
        }
      });
...
},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],5:[function(require,module,exports){
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var CardCarousel = /*#__PURE__*/function () {
  function CardCarousel() {(0, _classCallCheck2["default"])(this, CardCarousel);
    this.init();
  }(0, _createClass2["default"])(CardCarousel, [{ key: "init", value: function init()

    {} }]);return CardCarousel;}();exports["default"] = CardCarousel;


window.slickCarousel = function (showName, toShow, toScroll) {
  var $mySlick = $(showName);
  ...
  $mySlick.slick(options);
  slick_arrow_btn_control($mySlick);
  slick_revival($mySlick, options);
  limit_slick_item_width($mySlick, toShow);
  setTimeout(function () {return window.LazyLoad.update();}, 100);
};

var limit_slick_item_width = function limit_slick_item_width($el, toShow) {
  if (toShow === 3) {
    $el.addClass("show-3");
  } else if (toShow == 4) {
    $el.addClass("show-4");
...
var slick_revival = function slick_revival($mySlick, options) {
  $mySlick.on("destroy", function (ev, slick) {
    //  @ts-ignore;
    ev.currentTarget.dataset.slickInit = false;
  });
...
var slick_arrow_btn_control = function slick_arrow_btn_control($mySlick) {
  $mySlick.on("beforeChange", function (event, slick, currentSlide, nextSlide) {
    if (nextSlide === (Math.ceil(slick.slideCount / 3) - 1) * 4) {
...
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var ClassifyLabel = /*#__PURE__*/function () {
  function ClassifyLabel() {(0, _classCallCheck2["default"])(this, ClassifyLabel);
    ...
    this.currentLabelNameBtn = $(".current-label-name");
    this.$labelCount = this.classifyLabel.find(".label-count");

    this.init();
  }(0, _createClass2["default"])(ClassifyLabel, [{ key: "init", value: function init()

    {
      if (!this.classifyLabel.length) return;
      this.mb_modal_box_init();
      this.mb_modal_show_off();
      this.pc_label_box_expand_reduce();
      this.pc_sititem_active_position();
      this.init_current_item_position($(".slider-items .item.active"));
    }

    /**
     * 移动端弹框内容初始化
     */ }, { key: "mb_modal_box_init", value: function mb_modal_box_init()
    {
      if (window.innerWidth > 768) return;
      this.$labelCount.append("<div class=\"modal-mask\"></div>");
      this.$labelCount.
      children(".label-wrap").
      append("<button class=\"close-btn\"><i class=\"icon-close\"></i></button>");
    }
    /**
     * 移动端弹框显示与隐藏
     */ }, { key: "mb_modal_show_off", value: function mb_modal_show_off()
    {var _this = this;
      //  显示
      this.currentLabelNameBtn.on("click", function () {
        _this.$labelCount.addClass("show");
      });

      //  隐藏

      this.$labelCount.on("click", ".close-btn,.modal-mask,.item", function () {
        _this.$labelCount.removeClass("show").addClass("hide");
        setTimeout(function () {
          _this.$labelCount.removeClass("hide");
        }, 380);
      });
    }
    /**
     * PC 端 label box 展开收起
     */ }, { key: "pc_label_box_expand_reduce", value: function pc_label_box_expand_reduce()
    {var _this2 = this;
      this.dropdownBtn.on("click", function (ev) {
        var $el = $(ev.currentTarget);
        if ($el.hasClass("active")) {
          $el.removeClass("active");
          _this2.classifyLabel.removeClass("open");
          _this2.init_current_item_position($(".slider-items>.active"));
        } else {
          $el.addClass("active");
          _this2.classifyLabel.addClass("open");
        }
      });
    }
    /**
     * PC 端点击item 执行动画
     */ }, { key: "pc_sititem_active_position", value: function pc_sititem_active_position()
    {var _this3 = this;
      var $item = this.classifyLabel.find(".slider-items .item");
      $item.on("click", function (ev) {
        _this3.init_current_item_position($(ev.currentTarget));
      });
    }
    /**
     * 当前选中标签在当前居中显示
     * @param {*} $active
     */ }, { key: "init_current_item_position", value: function init_current_item_position(
    $active) {
      $active.addClass("active").siblings(".item").removeClass("active");
      this.currentLabelNameBtn.find(".title").html($active.find("a").text());

      if (window.innerWidth > 767 && !this.classifyLabel.hasClass("open")) {
        var countWidth = this.$labelCount.outerWidth();
        var itemWidth = $active.outerWidth();
        var ItemOffsetLeft = $active.position().left;
        var $slider = this.$labelCount.find(".slider-items");
        var sliderWidth = (itemWidth + 16) * $slider.find(".item").length;
        var transformX = 0;
        //  判断滚动方向
        if (ItemOffsetLeft > countWidth / 2) {
          //  当滚动到最后1个 item 时的情况
          if (ItemOffsetLeft + itemWidth + 20 > sliderWidth) {
            transformX = sliderWidth - countWidth + itemWidth / 2;
          } else {
            transformX = ItemOffsetLeft - countWidth / 2 + itemWidth / 2;
          }
        } else {
          transformX = 0;
        }
...
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var CommercialPicture = /*#__PURE__*/function () {
  function CommercialPicture() {(0, _classCallCheck2["default"])(this, CommercialPicture);
     ...
     * @param {*} Img
     * @param {*} title
     */ }, { key: "picture", value: function picture(
    pcImg, tabImg, mbImg, title) {
      return "<picture>\n              ".concat(

      pcImg ? "<source data-srcset=\"".concat(
      pcImg, "\" media=\"(min-width: 1248px)\">") : "", "\n              ").concat(



      tabImg ? "<source data-srcset=\"".concat(
      tabImg, "\" media=\"(min-width: 768px) and (max-width:1247px)\">") : "", "\n              ").concat(



      mbImg ? "<source data-srcset=\"".concat(
      mbImg, "\" media=\"(max-width: 767px)\">") : "", "\n              <img class=\"lazy\" data-src=\"").concat(



      pcImg || mbImg || mbImg, "\" width=\"100%\" alt=\"").concat(
      title, "\" />\n            </picture>");

    }

    /**
     * 单个 item 添加 picture 图片数据
     * @param {JQuery} $el - 图片 item
     */ }, { key: "produce_a_picture", value: function produce_a_picture(
    $el) {var _this2 = this;
      var pcImg = $el.data("pc-img");
      var tabImg = $el.data("tab-img");
      var mbImg = $el.data("mb-img");
      var title = $el.data("title");

      //  创建picture 标签
      setTimeout(function () {
        $el.html(_this2.picture(pcImg, tabImg, mbImg, title));
        window.LazyLoad.update();

        setTimeout(function () {
          $el.
          closest(".popular-commercial-picture").
          append("<button class=\"close-btn\"><i class=\"icon-close\"></i></button>");
...
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var exhibitionApps = /*#__PURE__*/function () {
  function exhibitionApps() {(0, _classCallCheck2["default"])(this, exhibitionApps);
    ...
    /**
     * 显示下载app 框
     */ }, { key: "get_apps_show", value: function get_apps_show()
    {var _this = this;
      this.$getAppBtn.on("click", function () {
        _this.appsItemLength < 1 && _this.create_apps_structure();
        $(".exhibition-apps").addClass("show");
        $(".exhibition-apps").fadeIn(200);
        return false;
      });
    }
    /**
     * 隐藏下载app 框
     */ }, { key: "get_apps_hide", value: function get_apps_hide()
    {
      $(document).on("click", function () {
        $(".exhibition-apps").removeClass("show");
        $(".exhibition-apps").fadeOut(200);
      });

      $("body").on("click", ".get-apps,.exhibition-apps", function (ev) {
        ev = ev || window.event;
        ev.stopPropagation();
      });
    }
    /**
     * 创建apps 下载盒子模板
     */ }, { key: "create_apps_structure", value: function create_apps_structure()
    {
      var $div = $("<div/>");
      var appsItemHTML = "";
      var $noscriptHtml = $(".head-operate noscript").html();
      $div.append($noscriptHtml);
      $div.find("a").map(function (i, el) {
        appsItemHTML += "<div class=\"apps-item\">\n                          <div class=\"apps-sign\">\n                            <a href=\"".concat(

        $(el).attr(
        "href"), "\" class=\"symbol d-flex align-items-center\" target=\"_blank\">\n                              <img src=\"").concat(
        ...
        $(el).data(
        "apple-link"), "\" class=\"badge Apple\" target=\"_blank\">\n                              <img src=\"").concat(

        $(el).data("apple-img"), "\" alt=\"Apple\">\n                            </a>\n                            <a href=\"").concat(

        $(el).data(
        "google-link"), "\" class=\"badge Google\" target=\"_blank\">\n                              <img src=\"").concat(

        $(el).data(
        "google-img"), "\" alt=\"Google\">\n                            </a>\n                          </div>\n                      </div>");
      ...
      var appsBoxHTML = "<div class=\"exhibition-apps\">\n                          <div class=\"apps-container\">\n                            <div class=\"apps-carousel\">".concat(

      appsItemHTML, "</div>\n                          </div>\n                      </div>");



      this.appsItemLength = $div.find("a").length;
      this.headOperate.append(appsBoxHTML);
      this.appsItemLength > 1 && this.init_slick();
    } }, { key: "init_slick", value: function init_slick()
    ...
    {var _this2 = this;
      ...
      setTimeout(function () {
        _this2.headOperate.find(".apps-carousel").slick(options);
      }, 420);
...
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var FormSearch = /*#__PURE__*/function () {
  function FormSearch() {(0, _classCallCheck2["default"])(this, FormSearch);
    ...
    this.init();
  }(0, _createClass2["default"])(FormSearch, [{ key: "init", value: function init()

    {
      this.search_input_change();
    }
    /**
     *
     * @param {*} $searchChangeBtn  - 切换搜索按钮
     * @param {*} $form  - 搜索表单
     * @param {*} $input  - 搜索框
     * @param {*} type - 默认搜素类型
     */ }, { key: "init_search", value: function init_search(
    $searchChangeBtn, $form, $input, type) {
      var search_action_fn = function search_action_fn(type, name, action) {
        $form.attr("data-type", type);
        $input.attr("name", name);
        $form.attr("action", $form.attr("data-".concat(action)));
      };

      if (type === "site") {
        search_action_fn("site", "s", "localhost");
      } else if (type === "google") {
        search_action_fn("google", "q", "google");
      }
    ...
    /**
     * 搜索平台切换
     */ }, { key: "search_input_change", value: function search_input_change()
    {var _this = this;
      var timer = null;
      this.$searchForm.map(function (i, form) {
        var $inputPlate = $(form).find(".input-plate");
        var $input = $(form).find("input");
        var $clearBtn = $(form).find(".clear-btn");
        var $searchBtn = $(form).find(".search-btn");
        var $searchChangeBtn = $(form).find(".search-change-btn");
        var $searchOptions = $(form).find(".search-options");
        var defType = $(form).data("type");

        _this.init_search($searchChangeBtn, $(form), $input, defType);
        _this.clear_input_value($clearBtn, $input, $searchBtn);
        $inputPlate.on("click", function (ev) {return $input.focus();});
        //  如果没有google，则不往下执行
        if (typeof $(form).attr("no-gcse") !== "undefined") return;

        $("button[data-option=\"".concat(defType, "\"]")).addClass("active");
        $searchChangeBtn.on("click", function (ev) {
          ev.preventDefault();
          $searchOptions.addClass("show");
          return false;
        });

        $searchOptions.find(".opt-item").on("click", function (ev) {
    ...
    /**
     * 搜索项盒子隐藏操作
     * @param {*} $searchOptions - 搜索项盒子
     */ }, { key: "search_options_box_hide", value: function search_options_box_hide(
    $searchOptions) {
      $(document).on("click", function () {
        $searchOptions.removeClass("show");
      });
    ...
    /**
     * 搜索平台切换参数配置
     */ }, { key: "search_event", value: function search_event(
    ...
    /**
     * 搜索框的各种操作：回车搜索、清空输入框、判断输入空格....
     */ }, { key: "clear_input_value", value: function clear_input_value(

    $clearBtn, $input, $searchBtn) {
      //  回车搜索
      ...
      $searchBtn.on("click", function () {
        if ($input.get(0).value.trim() === "") return false;
      });
      //  清空搜索框
...
PopularAd = /*#__PURE__*/function () {
  function PopularAd() {(0, _classCallCheck2["default"])(this, PopularAd);
    this.articleBgType = $(".popular-article-bg");
    this.popTitle = this.articleBgType.find(".pop-article-title");
    this.popDesc = this.articleBgType.find(".pop-article-desc");

    this.init();
  }(0, _createClass2["default"])(PopularAd, [{ key: "init", value: function init()

    {
      this.desc_limit_line();
    } }, { key: "desc_limit_line", value: function desc_limit_line()

    {var _this = this;
      var limit_line = function limit_line() {
        var titleHeight = _this.popTitle.outerHeight();
        var titleFontSize = parseInt(
        get_style(_this.popTitle.get(0), "lineHeight"));

        var lint = titleHeight / titleFontSize;

        if (lint > 2) {
          _this.popDesc.hide();
        } else if (lint === 2) {
          _this.popDesc.attr("style", "-webkit-line-clamp: 1; max-height: 1.5em;");
        } else {
          _this.popDesc.show().removeAttr("style");
        }
      };

      limit_line();

      $(window).on("resize", this.debounce(limit_line, 200));
    } }, { key: "debounce", value: function debounce(
...
},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],12:[function(require,module,exports){
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var SparePartsFn = /*#__PURE__*/function () {
  function SparePartsFn() {(0, _classCallCheck2["default"])(this, SparePartsFn);
    this.init();
  }(0, _createClass2["default"])(SparePartsFn, [{ key: "init", value: function init()
    {
      this.banner_card_slick();
    } }, { key: "banner_card_slick", value: function banner_card_slick()

    {
      setTimeout(function () {
        var $preItem = $(".ban-item.slick-active").prev(".ban-item");
        $preItem.
        find("img.lazy").
        attr("src", $preItem.find("img.lazy").data("src")).
        addClass("loaded");
      }, 300);
    } }]);return SparePartsFn;}();exports["default"] = SparePartsFn;

},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],13:[function(require,module,exports){
  ...
  function Subscription() {(0, _classCallCheck2["default"])(this, Subscription);
  ...
  }(0, _createClass2["default"])(Subscription, [{ key: "init", value: function init()
    {
      var subBoxHFn = function subBoxHFn($el, subBox, open) {
        var $subEvent = $el.parents(".sub-event");
        var subBoxH = $subEvent.find(subBox).outerHeight();
        $subEvent.height(subBoxH + 2);
        open ? $subEvent.addClass("change") : $subEvent.removeClass("change");
      };

      this.viaEmail.on("click", function (ev) {
        subBoxHFn($(ev.currentTarget), ".email-subscribe", true);
      });
    ...
    {var _this = this;
      $('input[type="submit"],button[type="submit"],.messenger-payload').on(
      "click",
      function (ev) {
        var $subForm = $();
        if ($(ev.currentTarget).closest("form.mc4wp-form").length) {
          $subForm = $(ev.currentTarget).closest("form.mc4wp-form");
        } else if ($(ev.currentTarget).closest(".j-sub-form").length) {
          $subForm = $(ev.currentTarget).closest(".j-sub-form");
        } else {
          return;
        }
...
},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],14:[function(require,module,exports){
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var TabsSlickComponent = /*#__PURE__*/function () {
  function TabsSlickComponent(uniqueClass) {(0, _classCallCheck2["default"])(this, TabsSlickComponent);
    ...
    {var index = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
      ...
      //  处理tabs content显示动画
      if (this.$el.find(".tabs-slick-content-box .current").length === 0) {
        $currentContent.addClass("current");
      } else {
        $currentContent.addClass("tab-slick-fade-in");
        //  隐藏现在的
        this.$el.find(".tabs-slick-content-box .current").animate(
        {
          opacity: 0 },
...
},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],15:[function(require,module,exports){
...
TabsComponent = /*#__PURE__*/function () {
  function TabsComponent(uniqueClass) {(0, _classCallCheck2["default"])(this, TabsComponent);
    this.$el = $(".".concat(uniqueClass));
    this.$nav = this.$el.find(".tabs-mobile-nav");
    this.defaultIndex = this.$el.find(".tabs-list").data("default");
    this.defaultIndex = this.defaultIndex === undefined ? 0 : this.defaultIndex;
    this.T = new _tabs["default"]({
      el: ".".concat(uniqueClass, " .tabs"),
      index: this.defaultIndex });

    this.init(uniqueClass);
  }(0, _createClass2["default"])(TabsComponent, [{ key: "init", value: function init(

    uniqueClass) {
      //  处理 popover 效果
      this.popoverHandler();
      //  处理移动端得弹框
      this.modalHandler(uniqueClass);
      //  处理事件监听
      this.eventHandler();
      this.setMobileNavText(this.defaultIndex);
    } }, { key: "modalHandler", value: function modalHandler(

    uniqueClass) {var _this = this;
      var $modal = $("<div class=\"modal modal-".concat(uniqueClass, "\" />"));
    ...
    tabData) {var _this3 = this;
      ...
      this.setCurrentModalIem(current.index);
      this.M.animate({
        opacity: 1 });
    ...
    {var _this4 = this;
      ...
      this.$nav.on("click", function () {
        _this4.$el.trigger("customExpandMoreBtnClick");
      });
    ...
    {var _this5 = this;
      ...
      this.$popoverBox = this.$el.find(".popover-box");
...

    {
      ...
      return items;
    } }, { key: "hidePopover", value: function hidePopover()

    {
      this.$el.removeClass("popover");
      this.$popoverBox.fadeOut();
    } }, { key: "showPopover", value: function showPopover()

    {
      this.$el.addClass("popover");
      //  选中当前元素
      //  找到当前选中
      var currentIndex = this.$el.find(".tabs-list .current").data("index");
      this.setCurrentPopover(currentIndex);
      this.$popoverBox.fadeIn();
    } }, { key: "setCurrentModalIem", value: function setCurrentModalIem(

    index) {
      this.M.find(".modal-body button").
      eq(index).
      addClass("current").
      siblings().
      removeClass("current");
    } }, { key: "setCurrentPopover", value: function setCurrentPopover(
    ...
    } }]);return TabsComponent;}();var


Tabs = /*#__PURE__*/function () {
  function Tabs() {(0, _classCallCheck2["default"])(this, Tabs);
    this.init();
  }(0, _createClass2["default"])(Tabs, [{ key: "init", value: function init()

    {
      $(".tabs-component").map(function (index, el) {
        var randomId = Math.ceil(Math.random() * 99999);
        var uniqueClass = "tabs-".concat(randomId);
        el.classList.add(uniqueClass);
        new TabsComponent(uniqueClass);
      });
    } }]);return Tabs;}();exports["default"] = Tabs;

},{"../vendor/tabs.min":22,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],16:[function(require,module,exports){
"use strict";var _interopRequireDefault = require("@babel/runtime/helpers/interopRequireDefault");Object.defineProperty(exports, "__esModule", { value: true });exports["default"] = void 0;var _classCallCheck2 = _interopRequireDefault(require("@babel/runtime/helpers/classCallCheck"));var _createClass2 = _interopRequireDefault(require("@babel/runtime/helpers/createClass"));var Topics = /*#__PURE__*/function () {
  function Topics() {(0, _classCallCheck2["default"])(this, Topics);
    ...
    this.init();
  }(0, _createClass2["default"])(Topics, [{ key: "init", value: function init()

    {
      window.innerWidth < 768 && this.topics_slck_carousel();
    } }, { key: "topics_slck_carousel", value: function topics_slck_carousel()
...
},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],17:[function(require,module,exports){
...
Video = /*#__PURE__*/function () {
  function Video() {(0, _classCallCheck2["default"])(this, Video);
    this.init();
  }(0, _createClass2["default"])(Video, [{ key: "init", value: function init()

    {
      window.richSlick = _richSlick["default"];
    } }]);return Video;}();exports["default"] = Video;

},{"../vendor/rich-slick.min":21,"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27}],18:[function(require,module,exports){
...
},{"@babel/runtime/helpers/classCallCheck":25,"@babel/runtime/helpers/createClass":26,"@babel/runtime/helpers/interopRequireDefault":27,"@babel/runtime/helpers/typeof":28,"jquery":29}],21:[function(require,module,exports){
...
},{"@babel/runtime/helpers/interopRequireDefault":27,"@babel/runtime/helpers/typeof":28,"jquery":29}],24:[function(require,module,exports){
...
var _exhibitionApps = _interopRequireDefault(require("./modules/exhibition-apps"));
var _formSearch = _interopRequireDefault(require("./modules/form-search"));
